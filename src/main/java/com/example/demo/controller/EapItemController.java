...
public class EapItemController {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<EapItemResponseDto> atualizarParcialmente(@PathVariable Long id,
            @RequestBody Map<String, Object> updates) {
        return ResponseEntity.ok(eapItemService.atualizarParcialmente(id, updates));
    }
